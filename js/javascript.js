$.getJSON("php/pellicules_list.php", function(pellicules){
  ...
  for (n=0; n<pellicules.length; n++){
    ...
    "<article class=peli>"+
      ...
      "<a class=google href='https://www.google.com/search?q="+pellicules[n]["titol"]+" "+["director"]+"'><img src=img/icons/google.png></a>"+
      "<a class=eliminar href='php/eliminar_pellicula.php?id="+pellicules[n]["id"]+"'><img src=img/icons/delete.png></a>"+
    "</article>";
  }
